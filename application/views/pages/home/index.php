	...
	<div class="row">
		<div class="col-md-9">
			<div class="row">
				<div class="col-md-12">
					<div class="card mb-3">
						<div class="card-body text-white" style="background-color: #254636">
				...
				<?php foreach ($content as $row) : ?>
					<div class="col-md-6">
						<div class="card mb-3">
							...
							<div class="card-footer text-white" style="background-color: #254636">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card mb-3">
						...
						<ul class="list-group">
							<li class="list-group-item" style="background-color: #254636"><a class="text-white" href="<?= base_url('home') ?>">Semua kategori</a></li>
							<?php foreach (getCategories() as $category) : ?>
								<li class="list-group-item" style="background-color: #254636"><a class="text-white" href="<?= base_url("shop/category/$category->slug") ?>"><?= $category->title ?></a></li>
							<?php endforeach ?>
						</ul>
					</div>
				</div>
